...
export function Footer() {
  ...
  return (
    <footer className="mt-24 bg-background border-t border-border/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  <a
                    href="https://www.trustpilot.com/review/smsupports.com"
                    target="_blank"
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div>
              <h3 className="font-semibold text-foreground text-sm tracking-wide uppercase mb-6">Support</h3>
              <ul className="space-y-4">
