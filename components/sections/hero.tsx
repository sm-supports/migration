      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-30">
        <div className="text-center max-w-4xl mx-auto">
          <motion.div
            ...
            className="mb-6 sm:mb-8 px-3 sm:px-0"
          >
            <h1 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground leading-tight mb-4 sm:mb-6">
            ...
            <p className="text-lg sm:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed px-1">
          ...
          >
            <Button asChild size="lg" className="w-full sm:w-auto inline-flex items-center justify-center px-4 sm:px-6 py-3 min-h-[48px] sm:min-h-0">
              <Link href="/schedule">
            ...
            <Button asChild variant="outline" size="lg" className="w-full sm:w-auto group min-h-[48px] sm:min-h-0">
              <a href="https://api.whatsapp.com/send?phone=8801301360818&text=Hello%20Sm%20Supports!" target="_blank" rel="noopener noreferrer">
                <MessageCircle className="w-4 h-4 mr-2 group-hover:scale-110 transition-transform flex-shrink-0" />
                WhatsApp
              </a>
            </Button>
            
            <Button asChild variant="ghost" size="lg" className="w-full sm:w-auto group min-h-[48px] sm:min-h-0">
              <Link href="/projects">
                <>
                  <ExternalLink className="w-4 h-4 mr-2 group-hover:scale-110 transition-transform flex-shrink-0" />
                  View Projects
                </>
              </Link>
            </Button>
          ...
          <motion.div
            ...
            className="hidden sm:flex items-center justify-center space-x-8 text-sm text-muted-foreground"
          >
